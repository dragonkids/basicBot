...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/dragonkids/basicBot/master/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            "Ne izgleda dobro.",
            "MOLIM?!.",
            "Bolje da ti ne pricam.",
            "Primi me!!!",
            "Tvoja inteligencija jednaka je nuli!",
            "Parapapaaa, parapapapaaaa!",
            "Idi do psihologa.",
            "YES, YES, oooo YES!!!",
            "Mozda Ne.",
            "Odakle ja da znam?.",
            "Pitaj opet ako smes.",
            "Pretplatnika zabole za tvoje pitanje pokusaj kasnije.",
            "NE, NE, ooo NE!!!",
            "Moze bit a i ne mora.",
            "Hmm ne bih rekao :/ .",
            "Tako je!!!povikase seljaci.",
            "Ma jok!",
            "Naravno...da ne",
            "Alo nemoj da me silujes.",
            "Zabole te.",
            "Ti si puko!!!",
            "Ma ja ba druze, Winston Cercil!",
            "Ko ce ga znat?",
            "Izgleda dobro!",
            "Mozda?",
        ...
        chatUtilities: {
            chatFilter: function (chat) {
                ...
                if (msg.indexOf('autowoot was not enabled') > 0 || msg.indexOf('AFK message was not enabled') > 0 || msg.indexOf('!afkdisable') > 0 || msg.indexOf('!joindisable') > 0 || msg.indexOf('autowoot disabled') > 0 || msg.indexOf('AFK message disabled') > 0) {
                    API.moderateDeleteChat(chat.cid);
                    return true;
                }
             ...
             hahaCommand: {
                   ...
                   functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(basicBot.chat.haha);
                    }
                }
            },
            ...
            youtubeCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (typeof basicBot.settings.youtubeLink === "www.youtube.com")
